...
| Privacy and retention release check | `ASSESSMENT_SCREENSHOT_EXCEPTION_REGISTERED` | The original video, bulk derivatives, and review packs remain restricted. Three exact-hash Task 1 screenshots are explicitly registered as minimal assessment-use evidence in the canonical deck; re-encoding or adding media fails closed. |
